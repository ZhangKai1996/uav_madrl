...
"""
{
	...
	"Vehicles": {
		...
		"Drone2": {"VehicleType": "SimpleFlight","X": 8, "Y": 0, "Z": -2}
    }
}
"""
...
responses1 = client.simGetImages([
    ...
    vehicle_name="Drone1")  # scene vision image in uncompressed RGB array
print('Drone1: Retrieved images: %d' % len(responses1))
responses2 = client.simGetImages([
    airsim.ImageRequest("0", airsim.ImageType.DepthVis),  # depth visualization image
    airsim.ImageRequest("1", airsim.ImageType.Scene, False, False)],
    vehicle_name="Drone2")  # scene vision image in uncompressed RGB array
